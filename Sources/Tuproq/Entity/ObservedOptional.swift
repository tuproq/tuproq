...
@propertyWrapper
public final class ObservedOptional<V: Codable>: Codable {
    private var name: String?
    private var entityID: AnyHashable?
    private var entityName: String?
    private var value: V?

    @available(*, unavailable, message: "@ObservedOptional can only be applied to classes.")
    ...
    public static subscript<E: Entity>(
        ...
        storage storageKeyPath: ReferenceWritableKeyPath<E, ObservedOptional>
    ) -> V? {
        get {
